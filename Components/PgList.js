...
function PgList() {
  return (
    ...
    <Card style={{ width: "18rem" }}>
      <Link style={{textDecoration: "none", color: "black"}} href="/pglist">
        <Image className="d-block w-100 h-100" src={car1} alt="First slide" />
        <Card.Body>
          <Card.Title>Usmans PG</Card.Title>
    ...
    <Card style={{ width: "18rem" }}>
      <Link style={{textDecoration: "none", color: "black"}} href="/hostellist">
        ...
        <Card.Body>
          <Card.Title>Zakiyas PG</Card.Title>
    ...
    <Card style={{ width: "18rem" }}>
      <Link style={{textDecoration: "none", color: "black"}} href="/hostellist">
        ...
        <Card.Body>
          <Card.Title>Olive PG</Card.Title>
          <Card.Text>South Kalamassery</Card.Text>
